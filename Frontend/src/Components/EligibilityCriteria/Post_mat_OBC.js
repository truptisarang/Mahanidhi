  ...
  return (
    <>
      <div style={{ margin: "3rem" }}>
        <h3>Post Matric Scholarship to OBC students</h3>
        <div>
          ...
          <div>
            ...
            Maintenance Allowance are paid to only OBC category students.
            <br></br>
          </div>
          <hr></hr>
          <b>Benefits</b>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div>2) Applicants must be belongs to OBC category.</div>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div>
                2) In case of OBC if Applicant fails for a year then the
