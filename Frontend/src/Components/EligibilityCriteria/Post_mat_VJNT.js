      ...
      <div style={{ margin: "3rem" }}>
        ...
        <div>
          ...
          <div>
            ...
            Maintenance Allowance are paid to only VJNT category students.
            <br></br>
          </div>
          <hr></hr>
          <b>Benefits</b>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div>2) Applicants must be belongs to VJNT category.</div>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div>
                2) In case of VJNT if Applicant fails for a year then the
        ...
        <center><Button variant='contained' href="/post-matric-vjnt-form">apply</Button></center>
      </div>
    </>
  );
};

export default Post_mat_VJNT;
